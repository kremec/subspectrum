...
data class INCIY(
    ...
    override fun execute() {
        ...
        val result = iyRegisterPairValue.inc()
        Registers.specialPurposeRegisters.setIY(result)
    }

    override fun toString(): String = "INC IY"

    companion object : InstructionDefinition {
        override val mCycles: Int = 2
        override val tStates: Int = 10

        override val bitPattern = BitPattern.of("111111101 00100011")
