...
data class ADCAn(
    ...
    override fun execute() {
        ...
        val result = aRegisterValue.plus(sourceByte).plus(carryValue).toByte()
    ...
    override fun toString(): String = "ADC A, $sourceByte"

    companion object : InstructionDefinition {
        override val mCycles: Int = 2
        override val tStates: Int = 7

        override val bitPattern = BitPattern.of("11001110 nnnnnnnn")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return ADCAn(address, bytes, sourceByte)
        }
    }
}