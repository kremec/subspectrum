...
data class ORr(
    ...
    override fun execute() {
        ...
        val result = aRegisterValue.or(sourceValue)
    ...
    override fun toString(): String = "OR $sourceRegister"

    companion object : InstructionDefinition {
        override val mCycles: Int = 1
        override val tStates: Int = 4

        override val bitPattern = BitPattern.of("10110rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return ORr(address, bytes, sourceRegister)
        }
    }
}
