...
data class SBCAIXd(
    ...
    override fun execute() {
        ...
        val result = aRegisterValue.minus(sourceMemoryValue).minus(carryValue).toByte()
    ...
    override fun toString(): String = "SBC A, (IX + ${displacement})"

    companion object : InstructionDefinition {
        override val mCycles: Int = 5
        override val tStates: Int = 19

        override val bitPattern = BitPattern.of("11011101 10011110 dddddddd")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return SBCAIXd(address, bytes, displacement)
        }
    }
}
