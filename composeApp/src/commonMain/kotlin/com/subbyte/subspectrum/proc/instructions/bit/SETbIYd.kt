...
data class SETbIYd(
    ...
    override fun toString(): String = "SET $bitPosition, (IY${displacement.displayStringDisplacement()})"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11111101 11001011 dddddddd 11bbb110")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return SETbIYd(address, bytes, bitPosition, displacement)
        }
    }
}
