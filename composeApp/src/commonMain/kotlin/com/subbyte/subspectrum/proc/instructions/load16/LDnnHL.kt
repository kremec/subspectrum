...
data class LDnnHL(
    ...
    override fun toString(): String = "LD (${destinationWord.toHexString(HexFormat.UpperCase)}h), HL"

    companion object : InstructionDefinition {
        override val mCycles: Int = 5
        override val tStates: Int = 16

        override val bitPattern = BitPattern.of("00100010 nnnnnnnn nnnnnnnn")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return LDnnHL(address, bytes, destinationWord)
        }
    }
}