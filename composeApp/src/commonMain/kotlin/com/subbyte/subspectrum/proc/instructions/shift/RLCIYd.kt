...
data class RLCIYd(
    ...
    override fun toString(): String = "RLC (IY${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11111101 11001011 dddddddd 00000rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RLCIYd(address, bytes, displacement, destinationRegister)
        }
    }
}
