...
data class RLIXd(
    ...
    override fun toString(): String = "RL (IX${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11011101 11001011 dddddddd 00010rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RLIXd(address, bytes, displacement, destinationRegister)
        }
    }
}
