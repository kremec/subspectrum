...
data class RLr(
    ...
    override fun execute() {
        ...
        val result = (sourceRegisterValue.toInt() shl 1).toByte().setBit(0, oldCarryValue)
    ...
    override fun toString(): String = "RL $sourceRegister"

    companion object : InstructionDefinition {
        override val mCycles: Int = 2
        override val tStates: Int = 8

        override val bitPattern = BitPattern.of("11001011 00010rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RLr(address, bytes, sourceRegister)
        }
    }
}
