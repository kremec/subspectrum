...
data class RRCIXd(
    ...
    override fun toString(): String = "RRC (IX${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11011101 11001011 dddddddd 00001rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RRCIXd(address, bytes, displacement, destinationRegister)
        }
    }
}
