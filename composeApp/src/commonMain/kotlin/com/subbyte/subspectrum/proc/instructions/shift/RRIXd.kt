...
data class RRIXd(
    ...
    override fun toString(): String = "RR (IX${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11011101 11001011 dddddddd 00011rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RRIXd(address, bytes, displacement, destinationRegister)
        }
    }
}
