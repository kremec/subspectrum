...
data class RRIYd(
    ...
    override fun toString(): String = "RR (IY${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11111101 11001011 dddddddd 00011rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return RRIYd(address, bytes, displacement, destinationRegister)
        }
    }
}
