...
data class SLAIYd(
    ...
    override fun toString(): String = "SLA (IY${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11111101 11001011 dddddddd 00100rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return SLAIYd(address, bytes, displacement, destinationRegister)
        }
    }
}
