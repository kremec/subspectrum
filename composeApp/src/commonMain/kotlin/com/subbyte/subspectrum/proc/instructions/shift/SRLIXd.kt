...
data class SRLIXd(
    ...
    override fun toString(): String = "SRL (IX${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11011101 11001011 dddddddd 00111rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return SRLIXd(address, bytes, displacement, destinationRegister)
        }
    }
}
