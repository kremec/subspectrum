...
data class SLLIYd(
    ...
    override fun toString(): String = "SLL (IY${displacement.displayStringDisplacement()})${destinationRegister?.let { ", $it" } ?: ""}"

    companion object : InstructionDefinition {
        override val bitPattern = BitPattern.of("11111101 11001011 dddddddd 00110rrr")
        override fun decode(word: Long, address: Address): Instruction {
            ...
            return SLLIYd(address, bytes, displacement, destinationRegister)
        }
    }
}
