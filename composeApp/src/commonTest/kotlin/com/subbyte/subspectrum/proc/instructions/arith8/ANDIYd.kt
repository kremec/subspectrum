...
class ANDIYdTest {
    ...
    fun decodeInstruction() {
        val instruction = ANDIYd.decode(0xFDA605L, 0x1000u)
        ...
        val andIYd = instruction as ANDIYd
        assertEquals(0x05.toByte(), andIYd.displacement)
    }

    @Test
    fun executeAndWithIYOffset() {
        ...
        val instruction = ANDIYd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xFD.toByte(), 0xA6.toByte(), 0x05.toByte())),
    ...
    fun toStringFormat() {
        ...
        assertEquals("AND (IY+05h)", instruction.toString())
    }
}
