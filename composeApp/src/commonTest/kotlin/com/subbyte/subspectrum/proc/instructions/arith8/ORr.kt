...
class ORrTest {
    ...
    fun executeOrRegisters() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB1.toByte())),
    ...
    fun testZeroFlag() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB0.toByte())),
    ...
    fun testParityEven() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB2.toByte())),
    ...
    fun testParityOdd() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB3.toByte())),
    ...
    fun testHFlagAlwaysReset() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB4.toByte())),
    ...
    fun testNFlagAlwaysReset() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB5.toByte())),
    ...
    fun testCFlagAlwaysReset() {
        ...
        val instruction = ORr(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xB7.toByte())),
