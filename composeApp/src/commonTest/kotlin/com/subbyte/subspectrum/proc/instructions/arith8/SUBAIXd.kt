...
class SUBAIXdTest {
    ...
    fun decodeInstruction() {
        val instruction = SUBAIXd.decode(0xDD9605L, 0x1000u)
        ...
        val subAIXd = instruction as SUBAIXd
        assertEquals(0x05.toByte(), subAIXd.displacement)
    }

    @Test
    fun executeSubWithIXOffset() {
        ...
        val instruction = SUBAIXd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xDD.toByte(), 0x96.toByte(), 0x05.toByte())),
    ...
    fun toStringFormat() {
        ...
        assertEquals("SUB A, (IX+05h)", instruction.toString())
    }
}
