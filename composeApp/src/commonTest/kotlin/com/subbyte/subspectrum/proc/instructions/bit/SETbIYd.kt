...
class SETbIYdTest {
    ...
    fun decodeInstruction() {
        ...
        assertEquals(0, setbIYd.bitPosition)
    ...
    fun decodeInstructionBit7() {
        ...
        val setbIYd = instruction as SETbIYd
        assertEquals(7, setbIYd.bitPosition)
    ...
    fun executeSetBit() {
        ...
        val instruction = SETbIYd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xFD.toByte(), 0xCB.toByte(), 0x05.toByte(), 0xC6.toByte())),
            bitPosition = 0,
            displacement = 5
        )
    ...
    fun executeSetBit7() {
        ...
        val instruction = SETbIYd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xFD.toByte(), 0xCB.toByte(), 0x0A.toByte(), 0xFE.toByte())),
            bitPosition = 7,
            displacement = 10
        )
    ...
    fun executeSetNegativeDisplacement() {
        ...
        val instruction = SETbIYd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xFD.toByte(), 0xCB.toByte(), 0xFB.toByte(), 0xC6.toByte())),
            bitPosition = 0,
            displacement = -5
        )
    ...
    fun toStringFormat() {
        ...
        assertEquals("SET 0, (IY+05h)", instruction.toString())
    }
    ...
    fun toStringFormatNegativeDisplacement() {
        ...
        assertEquals("SET 3, (IY-05h)", instruction.toString())
    }
}
