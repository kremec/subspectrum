...
class JRZdTest {
    ...
    fun executeJumpWhenZeroSet() {
        ...
        val instruction = JRZd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0x28.toByte(), 0x10.toByte())),
            displacement = 0x10
        )
    ...
    fun executeJumpBackwardWhenZeroSet() {
        ...
        val instruction = JRZd(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0x28.toByte(), 0xF0.toByte())),
    ...
    fun toStringFormat() {
        ...
        assertEquals("JR Z, +10h", instruction.toString())
    }
