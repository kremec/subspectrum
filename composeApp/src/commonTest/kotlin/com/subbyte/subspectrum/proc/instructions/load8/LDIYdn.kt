...
class LDIYdnTest {
    ...
    fun decodeInstruction() {
        ...
        assertEquals(0xAB.toUByte(), ldIYdn.sourceUByte)
    }
    ...
    fun executeLoadImmediateToMemoryIY() {
        ...
        val instruction = LDIYdn(
            address = 0x1000u,
            bytes = DataByteArray(byteArrayOf(0xFD.toByte(), 0x36.toByte(), 0x05.toByte(), 0xFF.toByte())),
    ...
    fun toStringFormat() {
        ...
        assertEquals("LD (IY+05h), FFh", instruction.toString())
    }
}
